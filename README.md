...
- **Interface Moderna:** Construída em Dark Mode utilizando a biblioteca `customtkinter`.
- **Importação Flexível:**
  - Seleção de imagens direto dos arquivos do computador.
  - Captura de fotos em tempo real usando a webcam.
- **Mesa de Edição (Em construção):** Estrutura preparada para receber os algoritmos matemáticos e filtros personalizados.
...
```bash
git clone [https://github.com/Barrossm/Editor-de-fotos-magistrosas.git](https://github.com/Barrossm/Editor-de-fotos-magistrosas.git)
